...
// export default function AppointmentsPage() {
//   const queryClient = useQueryClient(); // ADDED: Query client for explicit invalidation
//   const { data: user } = useCurrentUser();
//   const [currentPage, setCurrentPage] = useState(1);
//   const pageSize = 5;
...
//         // ADDED: Force refresh immediately
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                ...
                {/* 🌟 NEW: Simplified Footer Pagination Inside Table Wrapper */}
                {totalPages > 0 && (
