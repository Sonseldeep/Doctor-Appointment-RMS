...
function DashboardContent() {
  ...
  return (
    <div className="w-full space-y-6">
      {/* UPDATED: Removed the old placeholder raw unstyled heading text blocks.
          Your role-based child dashboard layouts already display their own highly stylized 
          greetings, resolving the layout overlap issue completely. */}
