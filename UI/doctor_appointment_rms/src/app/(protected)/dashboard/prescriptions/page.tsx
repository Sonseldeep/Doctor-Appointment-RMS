...
//             <div className="flex gap-2 justify-end pt-4">
//               <Button type="button" variant="outline" onClick={() => setIsEditing(false)} className="rounded-xl shadow-sm border-slate-200">
//                 <X size={16} className="mr-1" /> Cancel
//               </Button>
//               <Button type="button" onClick={handleUpdate} disabled={updateMutation.isPending} className="rounded-xl shadow-sm">
...
//         ) : isEditing ? (
//           /* --- EDIT VIEW --- */
//           <div className="space-y-4 bg-white p-6 rounded-2xl shadow-sm border border-indigo-100 animate-fade-in max-w-5xl">
//             <div className="space-y-1.5">
//               <label className="text-xs font-semibold text-gray-500">Diagnosis</label>
//               <Input value={editForm.diagnosis} onChange={(e) => setEditForm({...editForm, diagnosis: e.target.value})} />
//             </div>
...
//                   <label className="text-[10px] font-semibold text-gray-400 uppercase">Medication Name</label>
//                   <Input placeholder="Med Name" value={med.name} onChange={(e) => updateMedication(idx, 'name', e.target.value)} />
//                 </div>
...
//                     />
//                     <select 
//                       className="p-2 border rounded-xl bg-white text-xs focus:outline-blue-500 h-9" 
...
//                   <select className="w-full p-2 border rounded-xl bg-white h-9 focus:outline-blue-500" value={med.frequency} onChange={(e) => updateMedication(idx, 'frequency', e.target.value)}>
//                       <option value="">Select Frequency</option>
//                       {[1, 2, 3, 4, 5, 6].map(n => <option key={n} value={n}>{n} times/day</option>)}
//                   </select>
//                 </div>
...
//                 <div className="space-y-1">
//                   <label className="text-[10px] font-semibold text-gray-400 uppercase">Instructions</label>
//                   <select className="w-full p-2 border rounded-xl bg-white h-9 focus:outline-blue-500" value={med.instructions} onChange={(e) => updateMedication(idx, 'instructions', e.target.value)}>
//                       <option value="">Select Instruction</option>
//                       <option value="Before Food">Before Food</option>
//                       <option value="After Food">After Food</option>
//                   </select>
...
//                     <label className="text-[10px] font-semibold text-gray-400 uppercase">Duration (Days)</label>
//                     <Input placeholder="Duration (Days)" type="number" value={med.durationInDays} onChange={(e) => updateMedication(idx, 'durationInDays', parseInt(e.target.value, 10))} />
//                 </div>
//               </div>
//             ))}
...
export default function PrescriptionHistoryPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6 space-y-6 min-h-screen bg-slate-50/30">
      ...
      {/* --- STICKY HEADER (CONTAINED INSIDE THE BACKGROUND) --- */}
