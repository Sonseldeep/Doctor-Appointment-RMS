...
//             {/* Diagnosis Module with Export Button */}
// <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
//   <div>
//     <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Diagnosis File</h4>
...
//       size="sm" 
//       onClick={() => {
//         // 1. Log the entire note to verify what fields are present
//         console.log("Full Selected Note Object:", selectedNote);
        
//         // 2. Try to get appointmentId from the note object
//         const id = selectedNote?.appointmentId;
        
//         if (id) {
//           exportPdf(id);
//         } else {
//           // 3. Fallback: If you have an 'id' that represents the appointment, try that
//           // Sometimes the field is just 'id' depending on your backend
//           console.error("appointmentId is missing. Available keys:", Object.keys(selectedNote));
//           alert("Error: Missing Appointment ID. Please check the console for details.");
//         }
//       }} 
//       disabled={isExporting}
//       className="gap-2 rounded-xl"
//     >
//       {isExporting ? "Exporting..." : <Download size={15} />} Export PDF
//     </Button>
