...
// // Define the exact flat object structure returned by your backend API
...
// interface AppointmentCardProps {
//   appointment: ExtendedAppointment; // Properly typed to eliminate the unused local error
//   onCancel?: (id: string) => void;
//   onClick?: () => void;
//   isDoctorView?: boolean; 
// }
...
//     : (appointment.doctorName ? `Dr. ${appointment.doctorName}` : "Medical Practitioner");

//   // Subtitle Resolution
//   const displaySubtitle = isDoctorView
//     ? [appointment.patientSex, appointment.patientAge ? `${appointment.patientAge} yrs` : null].filter(Boolean).join(", ") || "Patient Profile"
//     : (appointment.doctorSpecialization || "General Practitioner");

//   // Routing exact photo URLs directly from your API payload response 
//   const displayAvatarUrl = isDoctorView 
