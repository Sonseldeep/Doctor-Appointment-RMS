...
//         {/* Left Column: Biography (Spans 2 columns) */}
...
//               ? doctor.bio 
//               : "This practitioner is fully accredited and dedicated to providing high-quality diagnostic and therapeutic healthcare services tailored to custom patient goals and conditions."}
//           </p>
//         </div>

//         {/* Right Column: Mini Sticky Quick Info Card */}
...
//                     <span className="font-bold text-slate-800 bg-slate-100 px-2 py-0.5 rounded">Anonymous Patient</span>
